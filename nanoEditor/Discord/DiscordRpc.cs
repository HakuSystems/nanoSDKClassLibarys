...
public class DiscordRpc
{
    ...
    public struct RichPresenceStruct
    {
        ...
        public IntPtr button1Text; /* max 128 bytes */
        public IntPtr button1Url; /* max 128 bytes */
        public IntPtr button2Text; /* max 128 bytes */
        public IntPtr button2Url; /* max 128 bytes */
    }
    ...
    public class RichPresence
    {
        ...
        public bool instance;
        public string button1Text; /* max 128 bytes */
        public string button1Url; /* max 128 bytes */
        public string button2Text; /* max 128 bytes */
        public string button2Url; /* max 128 bytes */
        ...
        internal RichPresenceStruct GetStruct()
        {
            ...
            _presence.button1Text = StrToPtr(button1Text);
            _presence.button1Url = StrToPtr(button1Url);
            _presence.button2Text = StrToPtr(button2Text);
        ...
        private IntPtr StrToPtr(string input)
        {
            ...
            for (var i = 0; i < convbytecnt + 1; i++) Marshal.WriteByte(buffer, i, 0);
            _buffers.Add(buffer);
